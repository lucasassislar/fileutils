...
namespace FileUtils.Automation.Video {
    ...
    public class KCluster {
        ...
        public static double EuclideanDistanceAlpha(Color c1, Color c2) {
            double distance = Math.Pow(c1.R - c2.R, 2) + Math.Pow(c1.G - c2.G, 2) + Math.Pow(c1.B - c2.B, 2) + Math.Pow(c1.A - c2.A, 2);
            return Math.Sqrt(distance);
        }
    }
}